...
const categories = {
  ...
  Categories.fruit: ShoppingCategory(
    'Fruit',
    Color.fromARGB(255, 145, 255, 0),
  ),
  Categories.meat: ShoppingCategory(
    'Meat',
    Color.fromARGB(255, 255, 102, 0),
  ),
  Categories.dairy: ShoppingCategory(
    'Dairy',
    Color.fromARGB(255, 0, 208, 255),
  ),
  Categories.carbs: ShoppingCategory(
    'Carbs',
  ...
  Categories.other: ShoppingCategory(
    'Other',
